...
When you do `Object.prototype` then you are actually referring from the `Object() function` to the very important object `Object.prototype`.

From the `Object.prototype` you have a property that can help you to refer back to the `Object() Function`. That property is called `Constructor`.
...
**Classes are just a wrap over what you have as functions.**
...
- Behind the scenes, when you do `class B extends A{}` it is actually creating `Prototypal Chaining`.
